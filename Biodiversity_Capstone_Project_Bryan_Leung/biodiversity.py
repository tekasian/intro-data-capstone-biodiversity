...
<title>biodiversity</title><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
...
<h1 id="Capstone-2:-Biodiversity-Project">Capstone 2: Biodiversity Project<a class="anchor-link" href="#Capstone-2:-Biodiversity-Project">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Introduction">Introduction<a class="anchor-link" href="#Introduction">&#182;</a></h1><p>You are a biodiversity analyst working for the National Parks Service.  You're going to help them analyze some data about species at various national parks.</p>
<p>Note: The data that you'll be working with for this project is <em>inspired</em> by real data, but is mostly fictional.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Step-1">Step 1<a class="anchor-link" href="#Step-1">&#182;</a></h1><p>Import the modules that you'll be using in this assignment:</p>
<ul>
<li><code>from matplotlib import pyplot as plt</code></li>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Step-2">Step 2<a class="anchor-link" href="#Step-2">&#182;</a></h1><p>You have been given two CSV files. <code>species_info.csv</code> with data about different species in our National Parks, including:</p>
<ul>
<li>The scientific name of each species</li>
<li>The common names of each species</li>
<li>The species conservation status</li>
</ul>
<p>Load the dataset and inspect it:</p>
<ul>
<li>Load <code>species_info.csv</code> into a DataFrame called <code>species</code></li>
</ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="s1">&#39;species_info.csv&#39;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Inspect each DataFrame using <code>.head()</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="k">print</span> <span class="n">species</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Step-3">Step 3<a class="anchor-link" href="#Step-3">&#182;</a></h1><p>Let's start by learning a bit more about our data.  Answer each of the following questions.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>How many different species are in the <code>species</code> DataFrame?</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="o">.</span><span class="n">scientific_name</span><span class="o">.</span><span class="n">nunique</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>What are the different values of <code>category</code> in <code>species</code>?</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="o">.</span><span class="n">category</span><span class="o">.</span><span class="n">unique</span><span class="p">()</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>array([&#39;Mammal&#39;, &#39;Bird&#39;, &#39;Reptile&#39;, &#39;Amphibian&#39;, &#39;Fish&#39;, &#39;Vascular Plant&#39;,
       &#39;Nonvascular Plant&#39;], dtype=object)</pre>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>What are the different values of <code>conservation_status</code>?</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="o">.</span><span class="n">conservation_status</span><span class="o">.</span><span class="n">unique</span><span class="p">()</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>array([nan, &#39;Species of Concern&#39;, &#39;Endangered&#39;, &#39;Threatened&#39;,
       &#39;In Recovery&#39;], dtype=object)</pre>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Step-4">Step 4<a class="anchor-link" href="#Step-4">&#182;</a></h1><p>Let's start doing some analysis!</p>
<p>The column <code>conservation_status</code> has several possible values:</p>
<ul>
<li><code>Species of Concern</code>: declining or appear to be in need of conservation</li>
<li><code>Threatened</code>: vulnerable to endangerment in the near future</li>
<li><code>Endangered</code>: seriously at risk of extinction</li>
<li><code>In Recovery</code>: formerly <code>Endangered</code>, but currnetly neither in danger of extinction throughout all or a significant portion of its range</li>
</ul>
<p>We'd like to count up how many species meet each of these criteria.  Use <code>groupby</code> to count how many <code>scientific_name</code> meet each of these criteria.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s1">&#39;conservation_status&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">scientific_name</span><span class="o">.</span><span class="n">nunique</span><span class="p">()</span><span class="o">.</span><span class="n">reset_index</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>As we saw before, there are far more than 200 species in the <code>species</code> table.  Clearly, only a small number of them are categorized as needing some sort of protection.  The rest have <code>conservation_status</code> equal to <code>None</code>.  Because <code>groupby</code> does not include <code>None</code>, we will need to fill in the null values.  We can do this using <code>.fillna</code>.  We pass in however we want to fill in our <code>None</code> values as an argument.</p>
<p>Paste the following code and run it to see replace <code>None</code> with <code>No Intervention</code>:</p>
<div class="highlight"><pre><span></span><span class="n">species</span><span class="o">.</span><span class="n">fillna</span><span class="p">(</span><span class="s1">&#39;No Intervention&#39;</span><span class="p">,</span> <span class="n">inplace</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="o">.</span><span class="n">fillna</span><span class="p">(</span><span class="s1">&#39;No Intervention&#39;</span><span class="p">,</span> <span class="n">inplace</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Great! Now run the same <code>groupby</code> as before to see how many species require <code>No Protection</code>.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's use <code>plt.bar</code> to create a bar chart.  First, let's sort the columns by how many species are in each categories.  We can do this using <code>.sort_values</code>.  We use the the keyword <code>by</code> to indicate which column we want to sort by.</p>
<p>Paste the following code and run it to create a new DataFrame called <code>protection_counts</code>, which is sorted by <code>scientific_name</code>:</p>
<div class="highlight"><pre><span></span><span class="n">protection_counts</span> <span class="o">=</span> <span class="n">species</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s1">&#39;conservation_status&#39;</span><span class="p">)</span>\
    <span class="o">.</span><span class="n">scientific_name</span><span class="o">.</span><span class="n">count</span><span class="p">()</span><span class="o">.</span><span class="n">reset_index</span><span class="p">()</span>\
    <span class="o">.</span><span class="n">sort_values</span><span class="p">(</span><span class="n">by</span><span class="o">=</span><span class="s1">&#39;scientific_name&#39;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">protection_counts</span> <span class="o">=</span> <span class="n">species</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s1">&#39;conservation_status&#39;</span><span class="p">)</span>\
    <span class="o">.</span><span class="n">scientific_name</span><span class="o">.</span><span class="n">count</span><span class="p">()</span><span class="o">.</span><span class="n">reset_index</span><span class="p">()</span>\
    <span class="o">.</span><span class="n">sort_values</span><span class="p">(</span><span class="n">by</span><span class="o">=</span><span class="s1">&#39;scientific_name&#39;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Now let's create a bar chart!</p>
<ol>
<li>Start by creating a wide figure with <code>figsize=(10, 4)</code></li>
<li>Start by creating an axes object called <code>ax</code> using <code>plt.subplot</code>.</li>
<li>Create a bar chart whose heights are equal to <code>scientific_name</code> column of <code>protection_counts</code>.</li>
<li>Create an x-tick for each of the bars.</li>
<li>Label each x-tick with the label from <code>conservation_status</code> in <code>protection_counts</code></li>
<li>Label the y-axis <code>Number of Species</code></li>
<li>Title the graph <code>Conservation Status by Species</code></li>
<li>Plot the grap using <code>plt.show()</code></li>
</ol>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">plt</span><span class="o">.</span><span class="n">figure</span><span class="p">(</span><span class="n">figsize</span><span class="o">=</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span><span class="mi">4</span><span class="p">))</span>
<span class="n">ax</span> <span class="o">=</span> <span class="n">plt</span><span class="o">.</span><span class="n">subplot</span><span class="p">()</span>
<span class="n">plt</span><span class="o">.</span><span class="n">bar</span><span class="p">(</span><span class="nb">range</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">protection_counts</span><span class="p">)),</span><span class="n">protection_counts</span><span class="o">.</span><span class="n">scientific_name</span><span class="p">)</span>
<span class="n">ax</span><span class="o">.</span><span class="n">set_xticks</span><span class="p">(</span><span class="nb">range</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">protection_counts</span><span class="p">)))</span>
<span class="n">ax</span><span class="o">.</span><span class="n">set_xticklabels</span><span class="p">(</span><span class="n">protection_counts</span><span class="o">.</span><span class="n">conservation_status</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">ylabel</span><span class="p">(</span><span class="s1">&#39;Number of Species&#39;</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="s1">&#39;Conservation Status by Species&#39;</span><span class="p">)</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Step-4">Step 4<a class="anchor-link" href="#Step-4">&#182;</a></h1><p>Are certain types of species more likely to be endangered?</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's create a new column in <code>species</code> called <code>is_protected</code>, which is <code>True</code> if <code>conservation_status</code> is not equal to <code>No Intervention</code>, and <code>False</code> otherwise.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="p">[</span><span class="s1">&#39;is_protected&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">species</span><span class="o">.</span><span class="n">conservation_status</span><span class="o">.</span><span class="n">apply</span><span class="p">(</span><span class="k">lambda</span> <span class="n">x</span><span class="p">:</span> <span class="s1">&#39;True&#39;</span> <span class="k">if</span> <span class="n">x</span> <span class="o">!=</span> <span class="s1">&#39;No Intervention&#39;</span> <span class="k">else</span> <span class="s1">&#39;False&#39;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's group by <em>both</em> <code>category</code> and <code>is_protected</code>.  Save your results to <code>category_counts</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">category_counts</span> <span class="o">=</span> <span class="n">species</span><span class="o">.</span><span class="n">groupby</span><span class="p">([</span><span class="s1">&#39;category&#39;</span><span class="p">,</span> <span class="s1">&#39;is_protected&#39;</span><span class="p">])</span><span class="o">.</span><span class="n">scientific_name</span><span class="o">.</span><span class="n">count</span><span class="p">()</span><span class="o">.</span><span class="n">reset_index</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Examine <code>category_count</code> using <code>head()</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="k">print</span> <span class="n">category_counts</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>    category is_protected  scientific_name
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>It's going to be easier to view this data if we pivot it.  Using <code>pivot</code>, rearange <code>category_counts</code> so that:</p>
<ul>
<li><code>columns</code> is <code>conservation_status</code></li>
<li><code>index</code> is <code>category</code></li>
<li><code>values</code> is <code>scientific_name</code></li>
</ul>
<p>Save your pivoted data to <code>category_pivot</code>. Remember to <code>reset_index()</code> at the end.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">category_pivot</span> <span class="o">=</span> <span class="n">category_counts</span><span class="o">.</span><span class="n">pivot</span><span class="p">(</span><span class="n">index</span><span class="o">=</span><span class="s1">&#39;category&#39;</span><span class="p">,</span> <span class="n">columns</span><span class="o">=</span><span class="s1">&#39;is_protected&#39;</span><span class="p">,</span> <span class="n">values</span><span class="o">=</span><span class="s1">&#39;scientific_name&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">reset_index</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Examine <code>category_pivot</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="k">print</span> <span class="n">category_pivot</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>is_protected           category  False  True
0                     Amphibian     73     7
1                          Bird    442    79
2                          Fish    116    11
3                        Mammal    176    38
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Use the <code>.columns</code> property to  rename the categories <code>True</code> and <code>False</code> to something more description:</p>
<ul>
<li>Leave <code>category</code> as <code>category</code></li>
<li>Rename <code>False</code> to <code>not_protected</code></li>
<li>Rename <code>True</code> to <code>protected</code></li>
</ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">category_pivot</span> <span class="o">=</span> <span class="n">category_pivot</span><span class="o">.</span><span class="n">rename</span><span class="p">(</span><span class="n">columns</span><span class="o">=</span><span class="p">{</span><span class="s1">&#39;False&#39;</span><span class="p">:</span> <span class="s1">&#39;not_protected&#39;</span><span class="p">,</span> <span class="s1">&#39;True&#39;</span><span class="p">:</span> <span class="s1">&#39;protected&#39;</span><span class="p">})</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's create a new column of <code>category_pivot</code> called <code>percent_protected</code>, which is equal to <code>protected</code> (the number of species that are protected) divided by <code>protected</code> plus <code>not_protected</code> (the total number of species).</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">category_pivot</span><span class="p">[</span><span class="s1">&#39;percent_protected&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">category_pivot</span><span class="o">.</span><span class="n">protected</span> <span class="o">/</span> <span class="p">(</span><span class="n">category_pivot</span><span class="o">.</span><span class="n">protected</span> <span class="o">+</span> <span class="n">category_pivot</span><span class="o">.</span><span class="n">not_protected</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>is_protected           category  not_protected  protected  percent_protected
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>It looks like species in category <code>Mammal</code> are more likely to be endangered than species in <code>Bird</code>.  We're going to do a significance test to see if this statement is true.  Before you do the significance test, consider the following questions:</p>
<ul>
<li>Is the data numerical or categorical?</li>
<li>How many pieces of data are you comparing?</li>
</ul>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Based on those answers, you should choose to do a <em>chi squared test</em>.  In order to run a chi squared test, we'll need to create a contingency table.  Our contingency table should look like this:</p>
<table>
<thead><tr>
<th></th>
<th>protected</th>
...
<p>Create a table called <code>contingency</code> and fill it in with the correct numbers</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">contingency</span> <span class="o">=</span> <span class="p">[[</span><span class="mi">38</span><span class="p">,</span> <span class="mi">176</span><span class="p">],</span> <span class="p">[</span><span class="mi">79</span><span class="p">,</span> <span class="mi">442</span><span class="p">]]</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>In order to perform our chi square test, we'll need to import the correct function from scipy.  Past the following code and run it:</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="kn">from</span> <span class="nn">scipy.stats</span> <span class="kn">import</span> <span class="n">chi2_contingency</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Now run <code>chi2_contingency</code> with <code>contingency</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">chi2</span><span class="p">,</span> <span class="n">pval</span><span class="p">,</span> <span class="n">dof</span><span class="p">,</span> <span class="n">expected</span> <span class="o">=</span> <span class="n">chi2_contingency</span><span class="p">(</span><span class="n">contingency</span><span class="p">)</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>It looks like this difference isn't significant!</p>
<p>Let's test another.  Is the difference between <code>Reptile</code> and <code>Mammal</code> significant?</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">contingency_2</span> <span class="o">=</span> <span class="p">[[</span><span class="mi">5</span><span class="p">,</span> <span class="mi">74</span><span class="p">],</span> <span class="p">[</span><span class="mi">38</span><span class="p">,</span> <span class="mi">176</span><span class="p">]]</span>
<span class="n">chi2</span><span class="p">,</span> <span class="n">pval</span><span class="p">,</span> <span class="n">dof</span><span class="p">,</span> <span class="n">expected</span> <span class="o">=</span> <span class="n">chi2_contingency</span><span class="p">(</span><span class="n">contingency_2</span><span class="p">)</span>
<span class="k">print</span> <span class="n">pval</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Yes! It looks like there is a significant difference between <code>Reptile</code> and <code>Mammal</code>!</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="Step-5">Step 5<a class="anchor-link" href="#Step-5">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Conservationists have been recording sightings of different species at several national parks for the past 7 days.  They've saved sent you their observations in a file called <code>observations.csv</code>.  Load <code>observations.csv</code> into a variable called <code>observations</code>, then use <code>head</code> to view the data.</p>
...
<span class="n">observations</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="s1">&#39;observations.csv&#39;</span><span class="p">)</span>
<span class="k">print</span> <span class="n">observations</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>            scientific_name                            park_name  observations
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Some scientists are studying the number of sheep sightings at different national parks.  There are several different scientific names for different types of sheep.  We'd like to know which rows of <code>species</code> are referring to sheep.  Notice that the following code will tell us whether or not a word occurs in a string:</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="c1"># Does &quot;Sheep&quot; occur in this string?</span>
<span class="n">str1</span> <span class="o">=</span> <span class="s1">&#39;This string contains Sheep&#39;</span>
<span class="s1">&#39;Sheep&#39;</span> <span class="ow">in</span> <span class="n">str1</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="c1"># Does &quot;Sheep&quot; occur in this string?</span>
<span class="n">str2</span> <span class="o">=</span> <span class="s1">&#39;This string contains Cows&#39;</span>
<span class="s1">&#39;Sheep&#39;</span> <span class="ow">in</span> <span class="n">str2</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Use <code>apply</code> and a <code>lambda</code> function to create a new column in <code>species</code> called <code>is_sheep</code> which is <code>True</code> if the <code>common_names</code> contains <code>'Sheep'</code>, and <code>False</code> otherwise.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="p">[</span><span class="s1">&#39;is_sheep&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">species</span><span class="o">.</span><span class="n">common_names</span><span class="o">.</span><span class="n">apply</span><span class="p">(</span><span class="k">lambda</span> <span class="n">x</span><span class="p">:</span> <span class="s1">&#39;Sheep&#39;</span> <span class="ow">in</span> <span class="n">x</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Select the rows of <code>species</code> where <code>is_sheep</code> is <code>True</code> and examine the results.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">species</span><span class="p">[</span><span class="n">species</span><span class="o">.</span><span class="n">is_sheep</span><span class="p">]</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Many of the results are actually plants.  Select the rows of <code>species</code> where <code>is_sheep</code> is <code>True</code> and <code>category</code> is <code>Mammal</code>.  Save the results to the variable <code>sheep_species</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">sheep_species</span> <span class="o">=</span> <span class="n">species</span><span class="p">[(</span><span class="n">species</span><span class="o">.</span><span class="n">is_sheep</span><span class="p">)</span> <span class="o">&amp;</span> <span class="p">(</span><span class="n">species</span><span class="o">.</span><span class="n">category</span> <span class="o">==</span> <span class="s1">&#39;Mammal&#39;</span><span class="p">)]</span>
<span class="k">print</span> <span class="n">sheep_species</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Now merge <code>sheep_species</code> with <code>observations</code> to get a DataFrame with observations of sheep.  Save this DataFrame as <code>sheep_observations</code>.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">sheep_observations</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">merge</span><span class="p">(</span><span class="n">sheep_species</span><span class="p">,</span> <span class="n">observations</span><span class="p">)</span>
<span class="k">print</span> <span class="n">sheep_observations</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>How many total sheep observations (across all three species) were made at each national park?  Use <code>groupby</code> to get the <code>sum</code> of <code>observations</code> for each <code>park_name</code>.  Save your answer to <code>obs_by_park</code>.</p>
<p>This is the total number of sheep observed in each park over the past 7 days.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">obs_by_park</span> <span class="o">=</span> <span class="n">sheep_observations</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s1">&#39;park_name&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">observations</span><span class="o">.</span><span class="n">sum</span><span class="p">()</span><span class="o">.</span><span class="n">reset_index</span><span class="p">()</span>
<span class="k">print</span> <span class="n">obs_by_park</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Create a bar chart showing the different number of observations per week at each park.</p>
<ol>
<li>Start by creating a wide figure with <code>figsize=(16, 4)</code></li>
<li>Start by creating an axes object called <code>ax</code> using <code>plt.subplot</code>.</li>
<li>Create a bar chart whose heights are equal to <code>observations</code> column of <code>obs_by_park</code>.</li>
<li>Create an x-tick for each of the bars.</li>
<li>Label each x-tick with the label from <code>park_name</code> in <code>obs_by_park</code></li>
<li>Label the y-axis <code>Number of Observations</code></li>
<li>Title the graph <code>Observations of Sheep per Week</code></li>
<li>Plot the grap using <code>plt.show()</code></li>
</ol>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="n">plt</span><span class="o">.</span><span class="n">figure</span><span class="p">(</span><span class="n">figsize</span><span class="o">=</span><span class="p">(</span><span class="mi">16</span><span class="p">,</span> <span class="mi">4</span><span class="p">))</span>
<span class="n">ax</span><span class="o">=</span><span class="n">plt</span><span class="o">.</span><span class="n">subplot</span><span class="p">()</span>
<span class="n">plt</span><span class="o">.</span><span class="n">bar</span><span class="p">(</span><span class="nb">range</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">obs_by_park</span><span class="p">)),</span><span class="n">obs_by_park</span><span class="o">.</span><span class="n">observations</span><span class="p">)</span>
<span class="n">ax</span><span class="o">.</span><span class="n">set_xticks</span><span class="p">(</span><span class="nb">range</span><span class="p">(</span><span class="nb">len</span><span class="p">(</span><span class="n">obs_by_park</span><span class="p">)))</span>
<span class="n">ax</span><span class="o">.</span><span class="n">set_xticklabels</span><span class="p">(</span><span class="n">obs_by_park</span><span class="o">.</span><span class="n">park_name</span><span class="p">)</span>
...
<span class="n">plt</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="s1">&#39;Observations of Sheep per Week&#39;</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Our scientists know that 15% of sheep at Bryce National Park have foot and mouth disease.  Park rangers at Yellowstone National Park have been running a program to reduce the rate of foot and mouth disease at that park.  The scientists want to test whether or not this program is working.  They want to be able to detect reductions of at least 5 percentage point.  For instance, if 10% of sheep in Yellowstone have foot and mouth disease, they'd like to be able to know this, with confidence.</p>
<p>Use the sample size calculator at <a href="https://www.optimizely.com/sample-size-calculator/">Optimizely</a> to calculate the number of sheep that they would need to observe from each park.  Use the default level of significance (90%).</p>
<p>Remember that "Minimum Detectable Effect" is a percent of the baseline.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="sd">&#39;&#39;&#39;Baseline = 15</span>
<span class="sd">Minimum_detectable_effect = 100*5 percentage points/baseline = 33.33%</span>
<span class="sd">Statistical significance = 90%</span>
<span class="sd">Sample_Size_Per_Park = 510</span>
<span class="sd">## From sample size calculator at Optimizely.&#39;&#39;&#39;</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>How many weeks would you need to observe sheep at Bryce National Park in order to observe enough sheep?  How many weeks would you need to observe at Yellowstone National Park to observe enough sheep?</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span></span><span class="sd">&#39;&#39;&#39;Bryce Weeks Observing = sample_size_per_park/Bryce observations</span>
<span class="sd">510/250 = 2.04 weeks</span>
<span class="sd">We need to spend 2.04 weeks at Bryce National Park in order to observe enough sheep.&#39;&#39;&#39;</span>
<span class="sd">&#39;&#39;&#39;Yellowstone Weeks Observing = sample_size_per_park/Yellowstone observations</span>
<span class="sd">510/507 = 1.00 week</span>
<span class="sd">We need to spend 1 week at Yellowstone National Park in order to observe enough sheep.&#39;&#39;&#39;</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>&#39;Yellowstone Weeks Observing = sample_size_per_park/Yellowstone observations\n510/507 = 1.00 week\nWe need to spend 1 week at Yellowstone National Park in order to observe enough sheep.&#39;</pre>
</div>
